...
public class ItemRepositorySpecs {
	...
	@Test
	public void repositorySavesOneItem() throws Exception {
		// Given an item in repository
		Item pen = new Item("pen", 1);
		...
		ResultSet resultSet = conn.createStatement().executeQuery("select name,quantity from item where name = '" + pen.getName() +"'");
		
		resultSet.next();
		// Then
		assertNotNull(resultSet);
		assertEquals(pen.getName(), resultSet.getString(1));
